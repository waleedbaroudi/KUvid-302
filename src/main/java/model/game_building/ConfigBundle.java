...
public class ConfigBundle {
	private int  numOfBlockersPerType, numOfPowerUpsPerType, numOfMoleculePerType;
	private double l;
	...
	public ConfigBundle(ArrayList<Integer> atoms, int numOfBlockersPerType, int numOfPowerUpsPerType,
			int numOfMoleculePerType, double l, boolean isLinearAlpha, boolean isLinearBeta, boolean isSpinningAlpha,
